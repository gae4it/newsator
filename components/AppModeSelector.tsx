...
export const AppModeSelector: React.FC<AppModeSelectorProps> = ({
  ...
  return (
    <div className="flex justify-center mb-0">
      <div className="bg-slate-200/50 dark:bg-slate-800/50 p-2 rounded-2xl flex flex-col md:flex-row gap-2 border border-slate-200 dark:border-slate-700 backdrop-blur-sm">
        <button
          onClick={() => onSelect(AppMode.RSS)}
          disabled={disabled}
          className={`
            flex items-center justify-center w-full md:w-auto gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-300
            ${
