...
const categoryColors: Record<NewsCategory, string> = {
  ...
  [NewsCategory.SOCIAL_TRENDS]:
    'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20',
  [NewsCategory.SPORT]: 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20',
};
    ...
    >
      ...
      <div className="flex-grow min-w-0">
        ...
        <div className="flex items-center gap-2 mt-1">
          <span
            className={`px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${categoryColors[category]}`}
          >
